...
while(true)
    ...
    % Add found branches to the list of fastmarching SourcePoints
...
%   Divide each skeleton segment into multiple segments to ensure that each
%   segment contains only 2 bifurcation/intersection/end-points, which are
%   the end-points of the segment
    ...
    for w=1:n
        ...
        l=max(l,length(ss));
        % end points of all skeleton segments (a total of 2n points)
