...
under the terms of the BSD License.  This code depeneds upon AVbin 
(http://code.google.com/p/avbin/), which is built on top of ffmpeg 
(ffmpeg.org), both of which are licensed under the GNU General Public 
License.  The GNU General Public License is compatible with the BSD 
licensing for this code.
**************************************************/
