function [R,R4,R2,I5,I3,Z1c,Z2c,Z0c,ar,ccr,fs,f,ft2,f1,cc2] = registration_phase_full_fast7(I1,I1_2,I2,H,k,sx,sy,ds,ds2,md,s,t,p)
...
ks = 0.95;
N1 = normalize1(I1_2,1); N1(N1 > ks) = 1;
