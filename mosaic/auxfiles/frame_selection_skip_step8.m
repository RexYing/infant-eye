function [V,hbsf,hbf,hf,bf,pf,hs,h,p] = frame_selection_skip_step8(dname2,H,s,sk,n,t,b1,d,ext,a,offset,sz)
...
hbf = a(1)*normalize1(tf,1) + a(2)*normalize1(hf,1) + a(3)*normalize1(bf,1);
