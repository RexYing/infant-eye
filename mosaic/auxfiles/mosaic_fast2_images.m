function [Mm,Mgb,M,Mg,Mc,R,R4,D,C,H,L,G,F0,t_ff,t_fm] = mosaic_fast2_images(dname,V,nums,bi,d)
...
for i = 1:ll
    [R{i},R4{i}] = ...
        registration_phase_full_fast6_alt(normalize1(L{1},1),normalize1(L{i+1},1),...
