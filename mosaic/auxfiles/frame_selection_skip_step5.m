function [hbsf,hbf,hf,bf,pf,hs,h,p] = frame_selection_skip_step5(fname,sk,n,t,b1,d,ext,a)
...
M = mmread_silent(vname,(j0-j2+1):(j0),[],false,true);
waitbar(1);
close(hh);
...
for i = 1:tp
    ...
    M = mmread_silent(vname,k,[],false,true);
